with open("app/src/main/java/com/example/ai/capabilities/RecursiveRepoAuditor.kt", "r") as f:
    code = f.read()

import re

new_auditor = """class RecursiveRepoAuditorImpl(
...
code = re.sub(r'class RecursiveRepoAuditorImpl[\s\S]*?\}\n\}', new_auditor, code)

with open("app/src/main/java/com/example/ai/capabilities/RecursiveRepoAuditor.kt", "w") as f:
    f.write(code)
