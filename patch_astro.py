with open("app/src/main/java/com/example/data/AstroNumerologyRepository.kt", "r") as f:
    content = f.read()

target = """    // In a real app, this would use Swiss Ephemeris for transits.
...
replacement = """    fun getZodiacSign(month: Int, day: Int): String {
        return when (month) {
...
with open("app/src/main/java/com/example/data/AstroNumerologyRepository.kt", "w") as f:
    f.write(content)
